// SECURITY NOTE: This exposes your API key in client-side code
// Only use this for testing or with proper security measures

const CAL_API_KEY = 'cal_live_b71e74be4843980a2000a1dedfc6d5d2';
const EVENT_TYPES = {
    '30min': '12345', // Replace with your actual event type IDs
    '60min': '67890'  // Find these in your Cal.com URL when viewing the event type
};
